...
//        $this->appsecret = $this->wechat_config['appsecret'];
    ...
    public function setConfigByDb()
    {
        ...
        if (!$systemConfig) {
            //获取所有系统配置
            $systemConfig = model('WeChat')->getWeChatData(1);
            cache('DB_WECHAT_CONFIG_DATA', null);
            cache('DB_WECHAT_CONFIG_DATA', $systemConfig, 36000); //缓存配置
        }
        return  $systemConfig;
    ...
    public function setConfigByCode()
    {
        $this->wechat_config = array(
            'appid' => 'wx0e5c62d7a3b6e004',
            'appsecret' =>'f4a68eb721db09f13e85c09caf079911'
